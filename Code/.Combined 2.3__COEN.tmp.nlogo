...
to set-up
  ...
  [ set shape "garbage can"
    set color red
    set size 2
    set ycor -750 + who * 1500           ; location of bins
...
to change-perceptionlevel
  if recycle-perception <= mean [recycle-perception] of other households in-radius 5
    [ifelse recycle-perception >= 0.490196      ; This function makes sure that recycle-perception cannot be higher than 0.5
      ...
      [set recycle-perception (recycle-perception / mean [recycle-perception] of other households in-radius 5) * recycle-perception ; multi
