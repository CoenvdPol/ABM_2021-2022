...
to setup
  ...
  create-wastecomps num-wastecomps[
    set color green
  ]
  ask wastecomps [
    set size 1.5  ;; easier to see
    setxy random-pxcor random-pycor ; Instead of randomization, we can also locate them based on the selected city
    set capacity max-capacity ; assume that they all have same capacity
...
to collect-wastes
  ;Either collection at home or central point collection --> This can be analysed
end
...
Plastic Recycling from Household Waste in the Netherlands
Goal: What are the trade-offs in the policy space of the municipalities if they wish 
to achieve the highest possible recycling rates?
1. What is the behaviour of the model under various parametrizations, and how does it relate to reality of plastics recycling? (Exploratory Model)
2. What is the influence of [different policies] or [sorting/production 
technologies] on the fraction of recycled plastics?* (Hypothesis-driven approach)(Aspects: compensation for sorters/incentives for consumers/education of 
consumers/legislation/laws/money for research/pre-sorting technology/post-
sorting technology/layered plastics/biodegradable plastics)
...
Recycling companies:
Have a specific recycling technology
Create offers to municipalities to process their waste
oEither collection at home or central point collection
oSpecify a fine for not getting enough plastic waste
Collect waste and process it
oBased on the technology they own
oRecovered plastics are sold for profit, based on exogenous prices
oRest is burned for energy recovery, and does not bring any 
money
o(Extra option) invest in new technology
